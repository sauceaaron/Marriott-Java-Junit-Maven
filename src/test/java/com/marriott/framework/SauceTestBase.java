...
public abstract class SauceTestBase implements SauceOnDemandSessionIdProvider {
    ...
    public static LinkedList browsersStrings() {
        LinkedList browsers = BrowserConfig.getBrowsers();
    ...
    public void setUp() throws Exception {
        ...
        String testName = this.getClass().getSimpleName().replace("_", " ") + " " + name.getMethodName().replace("_", " ");
        ...
        URL SAUCE_URL = new URL("https://" + username+ ":" + accesskey + seleniumURI +"/wd/hub");
        
	    System.out.println("TEST NAME: " + this.getClass().getSimpleName() + " " + name.getMethodName());
	    System.out.println("SAUCE_USERNAME:" + System.getenv("SAUCE_USERNAME"));
        System.out.println("SAUCE_ACCESS_KEY:" + System.getenv("SAUCE_ACCESS_KEY"));
        ...
        longWait = new WebDriverWait(driver, 60, 1000);
        mediumWait = new WebDriverWait(driver, 10, 500);
        shortWait = new WebDriverWait(driver, 2, 250);
        wait = longWait;
    }
